...
export default function Header() {
  ...
  if (!isMobile)
    return (
      <nav className="flex flex-col p-4 gap-4 justify-between bg-[#B03B48] dark:bg-zinc-900 dark:border-0 rounded-bl-md rounded-br-md">
        <div className="flex flex-row gap-2 items-center justify-between">
          <div className="relative lg:flex flex-row gap-4 items-center ">
            <FaEarthAsia size={24} color="#fafafa" aria-hidden="true" />
            <select
              value={region}
              onChange={(e) => {
